        ...
        for(String rankSection : ranksConfigList) {
        	...
        	//temporarily save player data in a map
        	   ...
        	   //if not then continue and check for the cost
              	loopNextRankCost = prxAPI.getIncreasedRankupCostX(main.playerStorage.getPlayerMaster(u) ,main.playerStorage.getPlayerPrestige(u), main.rankStorage.getRankupCost(rp));
