...
import me.hexiaranks.data.RankRandomCommands;
        ...
        for(String rankSection : ranksConfigList) {
        	...
        	String mapRank = rankupMaxMap.get(p);
        	   ...
        	   //if not then continue and check for the cost
              	loopNextRankCost = prxAPI.getIncreasedRankupCostX(main.playerStorage.getPlayerMaster(p) ,main.playerStorage.getPlayerPrestige(p), main.rankStorage.getRankupCost(rp));
