...
public interface GlobalDataStorage {
	...
	public default void loadGlobalData() {
		...
		boolean isGuiMasterList = registerBooleanData("Options.GUI-MASTERLIST");
		...
		String masterSoundName = registerStringData("Options.masterSound-name");
		double masterSoundVolume = registerDoubleData("Options.masterSound-volume");
		double masterSoundPitch = registerDoubleData("Options.masterSound-pitch");
