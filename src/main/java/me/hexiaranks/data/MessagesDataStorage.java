...
public class MessagesDataStorage {
	...
	public MessagesDataStorage(HexiaRanks main) {this.main = main;}
	...
	public void loadMessages() {
		...
		String masterNotFound = registerStringMessage("master-notfound");
		String setFirstMaster = registerStringMessage("setfirstmaster");
		String setLastMaster = registerStringMessage("setlastmaster");
		String setMaster = registerStringMessage("setmaster");
		String resetMaster = registerStringMessage("resetmaster");
		String createMaster = registerStringMessage("createmaster");
		String setMasterDisplay = registerStringMessage("setmasterdisplay");
		String setMasterCost = registerStringMessage("setmastercost");
		...
		String noMaster = registerStringMessage("nomaster");
		String delPlayerPrestige = registerStringMessage("delplayerprestige");
		String delPlayerMaster = registerStringMessage("delplayermaster");
		...
		String autoMasterEnabled = registerStringMessage("automaster-enabled");
		String autoMasterDisabled = registerStringMessage("automaster-disabled");
		String master = registerStringMessage("master");
		List<String> masterNotEnoughMoney = registerStringListMessage("master-notenoughmoney");
		List<String> lastMaster = registerStringListMessage("lastmaster");
		...
		String masterListLastPageReached = registerStringMessage("masterlist-last-page-reached");
		String masterListInvalidPage = registerStringMessage("masterlist-invalid-page");
		...
		String masterListConsole = registerStringMessage("masterlist-console");
		...
		List<String> topMastery = registerStringListMessage("top-mastery");
		String topMasteryLastPageReached = registerStringMessage("top-mastery-last-page-reached");
		String masterFailed = registerStringMessage("master-failed");
