...
public class TemplatePlugin extends JavaPlugin {
    ...
    // core settings
    public static String prefix = "&c&l[&5&lHexiaPrestige&c&l] &8&l"; // generally unchanged unless otherwise stated in config
    public static String consolePrefix = "[HexiaPrestige] ";
    ...
    private void registerCommands() {
        getCommand("hexpres").setExecutor(new MainPluginCommand(this));

        // set up tab completion
        getCommand("hexpres").setTabCompleter(new TabComplete(this));
    }
